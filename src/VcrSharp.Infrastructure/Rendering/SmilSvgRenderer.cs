...
/// <summary>
/// SMIL-based SVG renderer that uses visibility animations for partial updates.
/// Instead of rendering complete frames side-by-side (filmstrip), this renderer:
...
public class SmilSvgRenderer
{
    ...
    public SmilSvgRenderer(SessionOptions options)
    {
        _options = options;
        CalculateDimensions();
    }
